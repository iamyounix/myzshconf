...
Recommend Download: [Fira Nerd Fonts](https://github.com/ryanoasis/nerd-fonts/releases/download/v2.2.2/FiraCode.zip)

extract fonts and install using any Font Manager (1) to sSystem (2)
